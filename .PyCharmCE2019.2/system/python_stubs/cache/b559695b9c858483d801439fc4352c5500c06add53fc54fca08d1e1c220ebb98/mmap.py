...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f1d7675b208>'

__spec__ = None # (!) real value is "ModuleSpec(name='mmap', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f1d7675b208>, origin='/usr/lib/python3.7/lib-dynload/mmap.cpython-37m-x86_64-linux-gnu.so')"
