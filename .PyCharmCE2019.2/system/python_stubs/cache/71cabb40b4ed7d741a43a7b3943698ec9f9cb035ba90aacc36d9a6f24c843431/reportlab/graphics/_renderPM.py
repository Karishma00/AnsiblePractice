...
# from /usr/lib/python3/dist-packages/reportlab/graphics/_renderPM.cpython-37m-x86_64-linux-gnu.so
# by generator 1.147
"""
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd5a0a19eb8>'

__spec__ = None # (!) real value is "ModuleSpec(name='reportlab.graphics._renderPM', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd5a0a19eb8>, origin='/usr/lib/python3/dist-packages/reportlab/graphics/_renderPM.cpython-37m-x86_64-linux-gnu.so')"
