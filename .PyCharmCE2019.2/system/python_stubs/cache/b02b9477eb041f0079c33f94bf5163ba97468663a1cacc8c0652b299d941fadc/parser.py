...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f481e5ea208>'

__spec__ = None # (!) real value is "ModuleSpec(name='parser', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f481e5ea208>, origin='/usr/lib/python3.7/lib-dynload/parser.cpython-37m-x86_64-linux-gnu.so')"
