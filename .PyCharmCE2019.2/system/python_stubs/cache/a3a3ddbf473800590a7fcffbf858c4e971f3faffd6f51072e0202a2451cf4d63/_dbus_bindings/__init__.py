...
NULL_MAIN_LOOP = None # (!) real value is '<dbus.mainloop.NativeMainLoop object at 0x7ff307662060>'

_C_API = None # (!) real value is '<capsule object "_dbus_bindings._C_API" at 0x7ff3076622d0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff3078571d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_dbus_bindings', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff3078571d0>, origin='/usr/lib/python3/dist-packages/_dbus_bindings.cpython-37m-x86_64-linux-gnu.so')"
