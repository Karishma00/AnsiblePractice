...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f0914954198>'

__spec__ = None # (!) real value is "ModuleSpec(name='readline', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f0914954198>, origin='/usr/lib/python3.7/lib-dynload/readline.cpython-37m-x86_64-linux-gnu.so')"
