...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fcf78c957f0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_lzma', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fcf78c957f0>, origin='/usr/lib/python3.7/lib-dynload/_lzma.cpython-37m-x86_64-linux-gnu.so')"
