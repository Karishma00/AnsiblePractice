...
# from /usr/lib/python3/dist-packages/cairo/_cairo.cpython-37m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
CAPI = None # (!) real value is '<capsule object "cairo.CAPI" at 0x7f96bcbe0060>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f96bc5049b0>'

__spec__ = None # (!) real value is "ModuleSpec(name='cairo._cairo', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f96bc5049b0>, origin='/usr/lib/python3/dist-packages/cairo/_cairo.cpython-37m-x86_64-linux-gnu.so')"
