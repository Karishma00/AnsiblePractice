...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f53a631b208>'

__spec__ = None # (!) real value is "ModuleSpec(name='termios', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f53a631b208>, origin='/usr/lib/python3.7/lib-dynload/termios.cpython-37m-x86_64-linux-gnu.so')"
