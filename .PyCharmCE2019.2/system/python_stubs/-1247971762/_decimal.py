...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ffb949c81d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_decimal', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ffb949c81d0>, origin='/usr/lib/python3.7/lib-dynload/_decimal.cpython-37m-x86_64-linux-gnu.so')"
