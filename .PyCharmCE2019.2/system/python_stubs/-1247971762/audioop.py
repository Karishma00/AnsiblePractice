...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7a36369240>'

__spec__ = None # (!) real value is "ModuleSpec(name='audioop', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f7a36369240>, origin='/usr/lib/python3.7/lib-dynload/audioop.cpython-37m-x86_64-linux-gnu.so')"
