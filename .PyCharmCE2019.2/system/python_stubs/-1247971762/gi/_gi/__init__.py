...
TYPE_GSTRING = None # (!) real value is '<GType GString (34551040)>'

TYPE_INVALID = None # (!) real value is '<GType invalid (0)>'

_API = None # (!) real value is '<capsule object "gi._API" at 0x7f2ca10f5c00>'

_PyGObject_API = None # (!) real value is '<capsule object "gobject._PyGObject_API" at 0x7f2ca10f5ba0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f2ca112ca90>'

__spec__ = None # (!) real value is "ModuleSpec(name='gi._gi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f2ca112ca90>, origin='/usr/lib/python3/dist-packages/gi/_gi.cpython-37m-x86_64-linux-gnu.so')"
