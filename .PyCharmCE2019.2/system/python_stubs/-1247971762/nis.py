...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fbf16b17208>'

__spec__ = None # (!) real value is "ModuleSpec(name='nis', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fbf16b17208>, origin='/usr/lib/python3.7/lib-dynload/nis.cpython-37m-x86_64-linux-gnu.so')"
