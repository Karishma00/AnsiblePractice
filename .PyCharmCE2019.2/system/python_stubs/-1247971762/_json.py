...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd396394208>'

__spec__ = None # (!) real value is "ModuleSpec(name='_json', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd396394208>, origin='/usr/lib/python3.7/lib-dynload/_json.cpython-37m-x86_64-linux-gnu.so')"
