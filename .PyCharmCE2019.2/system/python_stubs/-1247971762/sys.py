...
version = '3.7.3 (default, Aug 20 2019, 17:04:43) \n[GCC 8.3.0]'
...
implementation = None # (!) real value is "namespace(_multiarch='x86_64-linux-gnu', cache_tag='cpython-37', hexversion=50791408, name='cpython', version=sys.version_info(major=3, minor=7, micro=3, releaselevel='final', serial=0))"
...
path_hooks = [
    ...
    None, # (!) real value is '<function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0x7fa6cf30e268>'
]
