# encoding: utf-8
# module netifaces
# from /usr/lib/python3/dist-packages/netifaces.cpython-37m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff01d50b198>'

__spec__ = None # (!) real value is "ModuleSpec(name='netifaces', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7ff01d50b198>, origin='/usr/lib/python3/dist-packages/netifaces.cpython-37m-x86_64-linux-gnu.so')"
