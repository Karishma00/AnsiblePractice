...
# from /usr/lib/python3/dist-packages/systemd/login.cpython-37m-x86_64-linux-gnu.so
# by generator 1.147
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f53789e8c18>'

__spec__ = None # (!) real value is "ModuleSpec(name='systemd.login', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f53789e8c18>, origin='/usr/lib/python3/dist-packages/systemd/login.cpython-37m-x86_64-linux-gnu.so')"
