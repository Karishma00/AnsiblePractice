...
# from /usr/lib/python3/dist-packages/_dbus_glib_bindings.cpython-37m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd8aa1a1208>'

__spec__ = None # (!) real value is "ModuleSpec(name='_dbus_glib_bindings', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd8aa1a1208>, origin='/usr/lib/python3/dist-packages/_dbus_glib_bindings.cpython-37m-x86_64-linux-gnu.so')"
