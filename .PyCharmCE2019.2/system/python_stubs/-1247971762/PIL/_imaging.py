# encoding: utf-8
# module PIL._imaging
# from /usr/lib/python3/dist-packages/PIL/_imaging.cpython-37m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f00d1aeee10>'

__spec__ = None # (!) real value is "ModuleSpec(name='PIL._imaging', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f00d1aeee10>, origin='/usr/lib/python3/dist-packages/PIL/_imaging.cpython-37m-x86_64-linux-gnu.so')"
