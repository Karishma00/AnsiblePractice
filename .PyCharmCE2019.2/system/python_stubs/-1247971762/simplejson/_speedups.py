...
# from /usr/lib/python3/dist-packages/simplejson/_speedups.cpython-37m-x86_64-linux-gnu.so
# by generator 1.147
""" simplejson speedups """
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f9f359feda0>'

__spec__ = None # (!) real value is "ModuleSpec(name='simplejson._speedups', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f9f359feda0>, origin='/usr/lib/python3/dist-packages/simplejson/_speedups.cpython-37m-x86_64-linux-gnu.so')"
